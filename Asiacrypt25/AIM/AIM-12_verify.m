...
e2:=3;
e3:=3;
L1:= [z^7 + z^6 + z^3 + z^2, z^6 + z^4 + z^3, z^7 + z^6 + z^5 + z^4 + z^3, z^7 + z^5 + z^4 + z^2 + z, z^7 + z^6 + z^3 + z^2 + z + 1, z^7 + z^6 + z^5 + z^2 + z + 1, z^4 + z^3 + z, z^5 + z^4 + z, z^6 + z^2 + 1, z^6 + z^4 + z^3, z^7 + z^6 + z^5 + z^2 + 1, z^6 + z^4 + z^3 + 1];
L2:= [z^7 + z^5 + z^4 + z + 1, z^7 + z^5 + z^4 + z^2 + z + 1, z^2 + 1, z^3 + z, z^7 + z^6 + z^5 + z^4 + z^2 + 1, z^6 + z^5 + z^2 + z, z^5 + z^4 + z^3 + z^2 + 1, z^3 + z^2 + 1, z^7 + z^6 + z^5 + z^4 + z + 1, z^6 + z^5 + z^4 + z^3 + z^2, z^7 + z^5 + z^4, z^7 + z^3 + z];
c1:=z^7 + z^6 + z^3 + z + 1;
c2:=z^7 + z^4 + z^3 + z^2 + z;
I1 := ideal<S | k^(2^12) + k>;
I2 := ideal<S | v^(2^12) + v>;
Q := quo<S | I1+I2 >;
...
function substitution(t) 
    ...
    vk:=1;
    for i in [1..s] do
        y:=z^11 + z^10 + z^8 + z^7 + z^6 + z^5 + z^3 + z + 1;
...
vv:=z^11 + z^8 + z^7 + z^6 + z^4 + z^3 + z^2;
...
b:=[z^10 + z^7 + z^5 + z^4 + z^3 + z^2 + z];
b cat:= [0 : i in [1..n-gamma-1]];
b cat:=[z^11 + z^10 + z^9 + z^8 + z^6 + z^5 + z^4 + z^3 + z];
