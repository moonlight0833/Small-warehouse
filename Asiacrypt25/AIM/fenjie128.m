...
B:=Transpose(A);
//b:=[Random(F)];
b:=[z^124 + z^122 + z^120 + z^119 + z^113 + z^111 + z^109 + z^107 + z^106 + z^103 + z^102 + z^100 + z^99 + z^98 + z^96 + z^94 + z^88 + z^84 + z^83 + z^81 + z^79 + z^76 + z^75 + z^74 + z^73 + z^71 + z^69 + z^65 + z^64 + z^62 + z^61 + z^59 + z^57 + z^55 + z^53 + z^52 + z^49 + z^48 + z^47 + z^46 + z^42 + z^36 + z^30 + z^29+ z^27 + z^25 + z^22 + z^21 + z^20 + z^18 + z^17 + z^16 + z^14 + z^12 + z^8 + z^4 + z^3 + z + 1];
b cat:= [0 : i in [1..n-gamma-1]];
//b cat:=[Random(F)];
b cat:=[z^125 + z^123 + z^122 + z^119 + z^116 + z^115 + z^113 + z^111 + z^108 + z^105 + z^104 + z^102 + z^101 + z^100 + z^97 + z^96 + z^95 + z^94 + z^85 +z^83 + z^81 + z^80 + z^78 + z^76 + z^75 + z^73 + z^72 + z^70 + z^69 + z^67 + z^66 + z^65 + z^64 + z^63 + z^61 + z^60 + z^59 + z^58 + z^56 + z^55 + z^51 + z^48 + z^47 + z^46 + z^43 + z^42 + z^40 + z^37 + z^34 + z^31 + z^30 + z^29 + z^27 + z^26 + z^25 + z^23 + z^22 + z^18 + z^15 + z^13 + z^11 + z^8 + z^7 + z^6 + z^3 + z^2];
...
/*
SetOutputFile("M_128_fenjie.m": Overwrite := true);
PrintFile("M_128_fenjie.m","L1:=");
PrintFile("M_128_fenjie.m",L1);
PrintFile("M_128_fenjie.m","L2:=");
PrintFile("M_128_fenjie.m",L2);
PrintFile("M_128_fenjie.m","L_a:=");
PrintFile("M_128_fenjie.m",L_a);
PrintFile("M_128_fenjie.m","L_alpha_1:=");
PrintFile("M_128_fenjie.m",L_alpha_1);
PrintFile("M_128_fenjie.m","L_alpha_2:=");
PrintFile("M_128_fenjie.m",L_alpha_2);
*/